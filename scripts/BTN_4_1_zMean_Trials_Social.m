...
tankfolder = 'C:\Photometry\Social_045 Photom\ChoicePun_(-10_+30)\zMean_240920';
...
%% save variables...
    ...
    temp2.zmean.collated_alc = [temp.zmean.alc_lat, temp.zmean.alc_BL, temp.zmean.alc_five, temp.zmean.alc_ten, temp.zmean.alc_cue, temp.zmean.alc_lever];
   
    temp2.zmean.collated_soc_labels = [soc_r_col, soc_s_col, soc_h_col, soc_ses_col];
    temp2.zmean.collated_soc = [temp.zmean.soc_lat, temp.zmean.soc_BL, temp.zmean.soc_five, temp.zmean.soc_ten, temp.zmean.soc_cue, temp.zmean.soc_lever];
